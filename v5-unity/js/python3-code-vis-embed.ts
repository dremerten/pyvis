...
function addVisualizerToPage(trace, divId, params) {
  ...
  if (params.editCodeBaseURL === undefined) {
    params.editCodeBaseURL = 'http://pythoncode-vis.com/visualize.html';
  }
...
// looks for all div.pycodevisVisualizer on the current page, extracts
...
function createAllVisualizersFromHtmlAttrs() {
  ...
  $('div.pycodevisVisualizer').each(function (i, e) {
