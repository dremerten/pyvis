...
function experimentalPopUpSyntaxErrorSurvey() {
  if (prevExecutionExceptionObjLst.length > 0) {
    ...
    if (codelineIDs.length === 1) {
      ...
      bub.destroyQTip();
      $(bub.hashID).qtip($.extend({}, pycodevis.qtipShared, {
      ...
      */
      ...
      $(bub.qTipContentID() + ' #syntaxErrSubmitBtn').click(function () {
        ...
        var resObj = {
          appState: optCommon.getAppState(),
      ...
      s.setAnnotations([{
        row: offendingLine - 1 /* zero-indexed */,
      ...
      $("#syntaxErrMsg").html(pycodevis.htmlspecialchars(prevExecutionExceptionObj.killerException.exception_msg));
