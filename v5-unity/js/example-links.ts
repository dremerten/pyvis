export var exampleHeaderHtml = `<p>Here are some free courses that either already use Python or are good to use with it:
</p>
...
<p style="margin-top: 5px;">(All Java examples created by <a href="https://github.com/daveagp"></a>)</p>`;
