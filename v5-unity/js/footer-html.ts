...
<a href="http://pythoncode-vis.com/">Python code-vis</a> (<a href="https://github.com/pgbovine/OnlinePythoncode-vis">code on GitHub</a>) supports seven
languages (despite its name!):</p>

<p>1. Python <a href="https://docs.python.org/2.7/">2.7</a> and <a
href="https://docs.python.org/3.14/">3.14</a> with these limited module
imports:
...
(There is also an experimental version of Python 3.14 with <a
href="https://docs.anaconda.com/anaconda/">Anaconda</a>, which lets
you import many more modules.)

<a
href="https://github.com/pgbovine/OnlinePythoncode-vis/tree/master/v5-unity">Backend source code</a>.
</p>

<p>2. Java using Oracle's Java 8. The original <a
href="http://cscircles.cemc.uwaterloo.ca/java_visualize/">Java
visualizer</a> was created by <a href="https://github.com/daveagp"></a> and .
It supports
...
<a
href="https://github.com/pgbovine/OnlinePythoncode-vis/tree/master/v4-cokapi/backends/java">Backend
source code</a>.</p>

<p>3. JavaScript (ES2024) running in Node.js. <a
href="https://github.com/pgbovine/OnlinePythoncode-vis/tree/master/v4-cokapi/backends/javascript">Backend
source code</a>.</p>
...
href="https://github.com/pgbovine/OnlinePythoncode-vis/tree/master/v4-cokapi/backends/ruby">Backend
source code</a>.</p>
